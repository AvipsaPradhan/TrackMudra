...
const calculateScore = (fund) => {
  const returnScore = (parseFloat(fund["3Y Returns"]) + parseFloat(fund["5Y Returns"])) / 2;
...
const RecommendedMutualFundsPage = () => {
  ...
  const renderMutualFundCard = (fund) => (
    <View key={fund['Scheme Code']} style={styles.card}>
      <View style={styles.cardHeader}>
        <View style={styles.cardInfo}>
          ...
          <View style={styles.subCategoryContainer}>
            ...
            <Text style={styles.expenseRatio}>Expense ratio: {fund['Expense Ratio']}%</Text>
          </View>
        </View>
      ...
      <TouchableOpacity style={styles.button} onPress={() => handleBuyPress(fund)}>
        <Text style={styles.buttonText}>One Time</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.button} onPress={() => handleSipPress(fund)}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.subTabs}>
        ...
        <TouchableOpacity onPress={() =>navigation.navigate('RecommendedMutualFundsPage')}>
          <Text style={[styles.subTab, styles.activeSubTab]}>Recommended</Text>
        </TouchableOpacity>
      </View>
