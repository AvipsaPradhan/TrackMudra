  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#002663" }}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerRightIcons}>
            <TouchableOpacity>
              <View style={{ flexDirection: 'row', paddingLeft: 10, paddingTop: 10 }}>
                ...
                <Image source={require('../assets/ranking (1).png')} style={styles.headerIcon} />
              </View>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.vouchersSection}>
          ...
          <View style={styles.vouchersContainer}>
            <View style={styles.voucherCard}>
              <Image source={require('../assets/puma.png')} style={styles.voucherImage1} />
            ...
            <View style={styles.voucherCard}>
              <Image source={require('../assets/spotify.png')} style={styles.voucherImage2} />
        ...
        <View style={styles.earnNowContainer}>
          <View style={styles.earnNowCard}>
            <Image source={require('../assets/megaphone.png')} style={styles.earnNowImage} />
          ...
          <View style={styles.earnNowCard}>
            <Image source={require('../assets/target.png')} style={styles.earnNowImage} />
            <View style={styles.earnNowTextContainer}>
          ...
          <View style={styles.earnNowCard}>
            <Image source={require('../assets/rating.png')} style={styles.earnNowImage} />
            <View style={styles.earnNowTextContainer}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity>
          <Image source={require('../assets/invlogo.png')} style={styles.footerIcon} />
        </TouchableOpacity>
        <TouchableOpacity>
